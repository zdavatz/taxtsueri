#![allow(dead_code)]
// Vendoriert aus der Crate `pdf417` v0.2.1 (github.com/Sofiman/pdf417), MIT-Lizenz,
// Copyright (c) 2023 Sofiane. Reine Daten/Logik (deps-frei). Siehe src/pdf417/LICENSE.
